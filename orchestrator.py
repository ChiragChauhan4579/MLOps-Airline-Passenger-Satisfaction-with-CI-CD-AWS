...
def model_retain():
    ...
    try:
        ...
        with mlflow.start_run():
            ...
            mlflow.log_artifact("C:/Users/Chirag/Desktop/MLOps/MLOps Airline Passenger Satisfaction/reports/validation_report.html","Data Validation report")
...
def workflow():
    ...
    if data_validity:
        ...
        if datadrift_check:
            ...
            model_retrain_status = model_retain()
        else:
